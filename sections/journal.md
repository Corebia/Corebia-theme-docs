...
**Journal** puts up to three hand-picked blog articles on the home page as editorial cards, with an optional "view all" link through to the blog.

It is available on the **home page only**.
...
- **Set the Blog setting even though the articles are picked by hand.** It is what the "View all" link points at; without it the link has nowhere to go.
...
- **Revisit it when you publish.** Articles are chosen individually, so the section keeps showing the same three until you change them.
