...
- **Large blocks of code.** They are hard to edit inside a settings field and are invisible to anyone reading the theme's files. Put those in the theme code instead. See [Custom code](../../customization/custom-code/).
