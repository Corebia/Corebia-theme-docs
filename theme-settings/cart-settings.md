...
Most of the cart's behaviour isn't configurable, because it follows your store rather than the theme. The [Cart page](../../templates/cart-page/) always includes:
...
- **If you turn it off, say so.** A store that runs promotions but hides the field will get support messages asking where to put the code.
