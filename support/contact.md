...
- The **documentation**, where every setting in the theme is covered under [Theme settings](../../theme-settings/), [Sections](../../sections/) and [Templates](../../templates/). If a setting isn't doing what you expect, its page usually says why.

## Need a customization?

Support covers the theme as it ships. For design changes, new features or integrations, hire a [Shopify Partner](https://www.shopify.com/partners/directory), who can extend Pave to your requirements. [Custom code](../../customization/custom-code/) explains where the line falls.
